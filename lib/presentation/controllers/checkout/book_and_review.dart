...
class BookAndReviewScreen extends StatefulWidget{
  ...
  BookAndReviewScreen({Key? key}) : super(key: key);

  @override
  _BookAndReviewScreen createState() => _BookAndReviewScreen();
}

class _BookAndReviewScreen extends State<BookAndReviewScreen>{
