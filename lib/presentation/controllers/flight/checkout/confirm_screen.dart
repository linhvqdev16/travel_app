...
class FlightConfirmScreen extends StatefulWidget {
  FlightConfirmScreen({Key? key}) : super(key: key);

  @override
  _FlightConfirmScreen createState() => _FlightConfirmScreen();
}

class _FlightConfirmScreen extends State<FlightConfirmScreen> {
  @override
